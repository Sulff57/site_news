...
if ((ISSET($_SESSION['login'])))
{
	...
	if ($droits_login['membres_droits_ajouter_membre'] == 1) 
	{
		...
		elseif ( $_GET['new'] == 0 )
		{
			...
			VALUES('$password', '$prenom', '$nom', '$pseudo', NOW(), '$droits', '$droits', '$droits', '$droits', 0)") or die('Erreur : Pseudo déjà existant. Veuillez revenir en arrière et en choisir un différent.'.mysql_error());
